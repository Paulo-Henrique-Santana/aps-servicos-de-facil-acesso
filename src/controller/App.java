...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent fxmlCadastroDadosPrestador = FXMLLoader.load(getClass().getResource("../view/cadastroDadosPrestador.fxml"));
        cadastroDadosPrestadorScene = new Scene(fxmlCadastroDadosPrestador);

        Parent fxmlCadastroCurriculoPrestador = FXMLLoader
                .load(getClass().getResource("../view/cadastroCurriculoPrestador.fxml"));
        cadastroCurriculoPrestadorScene = new Scene(fxmlCadastroCurriculoPrestador);

        Parent fxmlCadastroContratante = FXMLLoader.load(getClass().getResource("../view/cadastroContratante.fxml"));
        cadastroContratanteScene = new Scene(fxmlCadastroContratante);

        Parent fxmlServicosContratante = FXMLLoader.load(getClass().getResource("../view/servicosContratante.fxml"));
        servicosContratanteScene = new Scene(fxmlServicosContratante);

        Parent fxmlCadastroServicoScene = FXMLLoader.load(getClass().getResource("../view/cadastroServico.fxml"));
        cadastroServicoScene = new Scene(fxmlCadastroServicoScene);

        Parent fxmlServicosPrestadorScene = FXMLLoader.load(getClass().getResource("../view/servicosPrestador.fxml"));
        servicosPrestadorScene = new Scene(fxmlServicosPrestadorScene);

        Parent fxmlCandidatosScene = FXMLLoader.load(getClass().getResource("../view/candidatos.fxml"));
